...
time_steps = 9 # here means window number
...
X_test = test_data_part[:,0:45819]
T_test = test_data_part[:,45819:45820]
Y_test = test_data_part[:,45820:45821]

X_train = train_data_part[:,0:45819]
T_train = train_data_part[:,45819:45820]
Y_train = train_data_part[:,45820:45821]
...
print 'Evaluate DPM Baseline1...9 windows...CutPoint=12months...Simple RNN Model'
# Feature input part
