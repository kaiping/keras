...
file_x_train = open("/data/kaiping/data-test1053-train9476/train_data602");
X_train = np.genfromtxt(file_x_train, delimiter = ",");

file_y_train = open("/data/kaiping/data-test1053-train9476/train_label602");
Y_train = np.genfromtxt(file_y_train, delimiter = ",");

file_t_train = open("/data/kaiping/data-test1053-train9476/train_time602");
T_train = np.genfromtxt(file_t_train, delimiter = ",");

file_x_test = open("/data/kaiping/data-test1053-train9476/test_data820");
X_test = np.genfromtxt(file_x_test, delimiter = ",");

file_y_test = open("/data/kaiping/data-test1053-train9476/test_label820");
Y_test = np.genfromtxt(file_y_test, delimiter = ",");

file_t_test = open("/data/kaiping/data-test1053-train9476/test_time820");
