...
X_test_win10 = test_data_part[:,feature_dim * 9:feature_dim * 10]
X_test_win11 = test_data_part[:,feature_dim * 10:feature_dim * 11]
X_test_win12 = test_data_part[:,feature_dim * 11:feature_dim * 12]

T_test = test_data_part[:,feature_dim * 12:feature_dim * 12 + 1]
Y_test = test_data_part[:,feature_dim * 12 + 1:feature_dim * 12 + 2]
...
X_train_win10 = train_data_part[:,feature_dim * 9:feature_dim * 10]
X_train_win11 = train_data_part[:,feature_dim * 10:feature_dim * 11]
X_train_win12 = train_data_part[:,feature_dim * 11:feature_dim * 12]


T_train = train_data_part[:,feature_dim * 12:feature_dim * 12 + 1]
Y_train = train_data_part[:,feature_dim * 12 + 1:feature_dim * 12 + 2]
...
print 'X_train win10 shape:', X_train_win10.shape
print 'X_train win11 shape:', X_train_win11.shape
print 'X_train win12 shape:', X_train_win12.shape
...
print 'X_test win10 shape:', X_test_win10.shape
print 'X_test win11 shape:', X_test_win11.shape
print 'X_test win12 shape:', X_test_win12.shape
...
print 'Evaluate DPM Baseline1...12 windows...CutPoint=12months...MLP (all Dense) Model'
# Feature input part
...
feature_input_win10 = Input(shape=(feature_dim,), name='feature_input_win10')
feature_input_win11 = Input(shape=(feature_dim,), name='feature_input_win11')
feature_input_win12 = Input(shape=(feature_dim,), name='feature_input_win12')
...
mlp10 = Dense(mlp_dim)(feature_input_win10)
mlp11 = Dense(mlp_dim)(feature_input_win11)
mlp12 = Dense(mlp_dim)(feature_input_win12)
...
dense10 = Dense(dense_dim)(mlp10)
dense11 = Dense(dense_dim)(mlp11)
dense12 = Dense(dense_dim)(mlp12)
...
merge_output = merge([dense1, dense2, dense3, dense4, dense5, dense6, dense7, dense8, dense9, dense10, dense11, dense12, dense_time], mode='sum')

activation = Activation('tanh')(merge_output)
prediction = Dense(1)(activation)

model = Model(input=[feature_input_win1, feature_input_win2, feature_input_win3, feature_input_win4, feature_input_win5, feature_input_win6, feature_input_win7, feature_input_win8, feature_input_win9, feature_input_win10, feature_input_win11, feature_input_win12, time_input], output=[prediction])

model.compile(optimizer='rmsprop', loss='mean_squared_error', metrics=['mean_squared_error'])

history = model.fit([X_train_win1, X_train_win2, X_train_win3, X_train_win4, X_train_win5, X_train_win6, X_train_win7, X_train_win8, X_train_win9, X_train_win10, X_train_win11, X_train_win12, T_train], [Y_train], nb_epoch=nb_epochs, batch_size=batch_sizes, validation_data=([X_test_win1, X_test_win2, X_test_win3, X_test_win4, X_test_win5, X_test_win6, X_test_win7, X_test_win8, X_test_win9, X_test_win10, X_test_win11, X_test_win12, T_test], [Y_test]))

print "Some history information\n"
print history.history
plot(model, to_file='0628_dpm_model_12win_mlp.png')
