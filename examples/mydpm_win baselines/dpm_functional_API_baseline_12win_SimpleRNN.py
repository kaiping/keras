...
time_steps = 12 # here means window number
...
X_test = test_data_part[:,0:61092]
T_test = test_data_part[:,61092:61093]
Y_test = test_data_part[:,61093:61094]

X_train = train_data_part[:,0:61092]
T_train = train_data_part[:,61092:61093]
Y_train = train_data_part[:,61093:61094]
...
print 'Evaluate DPM Baseline1...12 windows...CutPoint=12months...Simple RNN Model'
# Feature input part
feature_input = Input(shape=(time_steps,feature_dim), name='feature_input')
#print('feature_input shape: ', feature_input.shape)
simplernn_out = SimpleRNN(rnn_dim, input_dim=feature_dim, input_length=time_steps)(feature_input)
#print('GRU shape: ', gru_out.shape)
dense1 = Dense(dense_dim)(simplernn_out)
