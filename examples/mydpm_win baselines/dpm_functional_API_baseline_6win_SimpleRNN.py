...
time_steps = 6 # here means window number
...
X_test = test_data_part[:,0:30546]
T_test = test_data_part[:,30546:30547]
Y_test = test_data_part[:,30547:30548]

X_train = train_data_part[:,0:30546]
T_train = train_data_part[:,30546:30547]
Y_train = train_data_part[:,30547:30548]
...
print 'Evaluate DPM Baseline1...6 windows...CutPoint=12months...Simple RNN Model'
# Feature input part
